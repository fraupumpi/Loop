...
final class ChartHUDController: HUDInterfaceController {
    ...
    @IBOutlet weak var watchGlucoseScene: WKInterfaceSKScene!
    ...
    override func awake(withContext context: Any?) {
        ...
        //  Initialize the graph even if we aren't the start page - otherwise
        //  it never gets done.
        ...
        let glucoseScene = GlucoseChartScene(size: graphSize)
